...
import { get as gl, transformExtent as X_, getTransform as K_, transform as pd } from "ol/proj";
...
}, mb = () => !1, co = (t) => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && (t.charCodeAt(2) > 122 || t.charCodeAt(2) < 97), Gl = (t) => t.startsWith("onUpdate:"), Qe = Object.assign, ah = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, gb = Object.prototype.hasOwnProperty, Ae = (t, e) => gb.call(t, e), le = Array.isArray, Ji = (t) => Lu(t) === "[object Map]", Cg = (t) => Lu(t) === "[object Set]", pe = (t) => typeof t == "function", rt = (t) => typeof t == "string", ds = (t) => typeof t == "symbol", Be = (t) => t !== null && typeof t == "object", oh = (t) => (Be(t) || pe(t)) && pe(t.then) && pe(t.catch), Pg = Object.prototype.toString, Lu = (t) => Pg.call(t), lh = (t) => Lu(t).slice(8, -1), Lg = (t) => Lu(t) === "[object Object]", uh = (t) => rt(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, La = /* @__PURE__ */ qr(
...
} : ds(e) ? lc(e) : Be(e) && !le(e) && !Lg(e) ? String(e) : e, lc = (t, e = "") => {
  var n;
...
function $o(t, e, n = !1, r = !1) {
  ...
  const { has: a } = Du(i), o = r ? dh : n ? ph : Xa;
  if (a.call(i, e))
    return o(t.get(e));
  if (a.call(i, s))
    return o(t.get(s));
...
const Xa = (t) => Be(t) ? Ru(t) : t, ph = (t) => Be(t) ? Jg(t) : t, n1 = "Computed is still dirty after getter evaluation, likely because a computed is mutating its own dependency in its getter. State mutations in computed getters should be avoided.  Check the docs for more details: https://vuejs.org/guide/essentials/computed.html#getters-should-be-side-effect-free";
class Qg {
  constructor(e, n, r, i) {
...
function vl(t, e, n) {
  return Ye(t) ? t : pe(t) ? new o1(t) : Be(t) && arguments.length > 1 ? ry(t, e, n) : we(t);
}
function ry(t, e, n) {
  const r = t[e];
...
function iy(t, e, n) {
  return rt(e) ? (e = JSON.stringify(e), n ? e : [`${t}=${e}`]) : typeof e == "number" || typeof e == "boolean" || e == null ? n ? e : [`${t}=${e}`] : Ye(e) ? (e = iy(t, _e(e.value), !0), n ? e : [`${t}=Ref<`, e, ">"]) : pe(e) ? [`${t}=fn${e.name ? `<${e.name}>` : ""}`] : (e = _e(e), n ? e : [`${t}=`, e]);
}
function h1(t, e) {
...
function Fu(t) {
  ...
  )) && (t.id == null ? Bt.push(t) : Bt.splice(m1(t.id), 0, t), ay());
}
function ay() {
...
function ql(t) {
  const e = ht;
  return ht = t, py = t && t.type.__scopeId || null, e;
}
...
function cc(t) {
  ...
  let b = y, E;
  if (process.env.NODE_ENV !== "production" && y.patchFlag > 0 && y.patchFlag & 2048 && ([b, E] = my(y)), v && m !== !1) {
    ...
    if (O.length) {
      if (N & 7)
        ...
        const M = Object.keys(o), L = [], I = [];
        for (let C = 0, R = M.length; C < R; C++) {
          const D = M[C];
          co(D) ? Gl(D) || L.push(D[2].toLowerCase() + D.slice(3)) : I.push(D);
        }
        I.length && q(
...
const pf = "components", I1 = "directives";
function R1(t, e) {
  return gy(pf, t, !0, e) || t;
}
...
function Sh(t, e, {
  ...
  const v = () => {
    if (!(!E.active || !E.dirty))
      if (e) {
        const M = E.run();
        (r || h || (d ? M.some((L, I) => xi(L, y[I])) : xi(M, y))) && (p && p(), Cn(e, u, 3, [
          M,
...
function mf(t, e, n, r) {
  const {
    ...
    onAfterAppear: y,
    onAppearCancelled: v
  } = e, b = String(t.key), E = by(n, t), O = (L, I) => {
    L && Cn(
      L,
      r,
      9,
    ...
    const C = I[1];
    O(L, I), le(L) ? L.every((R) => R.length <= 1) && C() : L.length <= 1 && C();
  }, M = {
    mode: s,
    persisted: a,
    beforeEnter(L) {
      ...
      const C = E[b];
      C && Xi(t, C) && C.el[si] && C.el[si](), O(I, [L]);
    },
    enter(L) {
      let I = l, C = u, R = f;
      if (!n.isMounted)
      ...
      let D = !1;
      const Q = L[Bo] = (ve) => {
        D || (D = !0, ve ? O(R, [L]) : O(C, [L]), M.delayedLeave && M.delayedLeave(), L[Bo] = void 0);
      };
      I ? N(I, [L, Q]) : Q();
    },
    leave(L, I) {
      ...
      let R = !1;
      const D = L[si] = (Q) => {
        R || (R = !0, I(), Q ? O(p, [L]) : O(d, [L]), L[si] = void 0, E[C] === t && delete E[C]);
      };
      E[C] = t, h ? N(h, [L, D]) : D();
    },
    clone(L) {
...
const Aa = (t) => !!t.type.__asyncLoader, po = (t) => t.type.__isKeepAlive;
function H1(t, e) {
  Sy(t, "a", e);
}
function z1(t, e) {
...
function Sy(t, e, n = St) {
  ...
  if (ju(e, r, n), n) {
    let i = n.parent;
    for (; i && i.parent; )
      po(i.parent.vnode) && Y1(r, e, n, i), i = i.parent;
  }
}
function Y1(t, e, n, r) {
  const i = ju(
...
const Yr = (t) => (e, n = St) => (!Gu || t === "sp") && ju(t, (...r) => e(...r), n), X1 = Yr("bm"), _n = Yr("m"), K1 = Yr("bu"), Z1 = Yr("u"), wy = Yr("bum"), Pi = Yr("um"), J1 = Yr("sp"), Q1 = Yr(
  "rtg"
), eE = Yr(
  "rtc"
);
...
function aE(t) {
  ...
  if (vf = !0, s)
    for (const z in s) {
      ...
      const Le = !pe(K) && pe(K.set) ? K.set.bind(n) : process.env.NODE_ENV !== "production" ? () => {
        q(
  ...
  if ($(X1, c), $(_n, h), $(K1, d), $(Z1, p), $(H1, m), $(z1, g), $(tE, L), $(eE, N), $(Q1, M), $(wy, v), $(Pi, E), $(J1, I), le(C))
    if (C.length) {
...
const Py = {}, Ly = () => Object.create(Py), ky = (t) => Object.getPrototypeOf(t) === Py;
...
function gE(t, e, n, r) {
  ...
  let u = !1;
  if (!(process.env.NODE_ENV !== "production" && mE(t)) && (r || a > 0) && !(a & 16)) {
    if (a & 8) {
...
function Rd(t) {
  return t[0] !== "$" && !La(t) ? !0 : (process.env.NODE_ENV !== "production" && q(`Invalid prop name: "${t}" is a reserved property.`), !1);
}
function Ef(t) {
  ...
  if (!(e == null && !a)) {
    if (s != null && s !== !0 && !l) {
      ...
      for (let h = 0; h < f.length && !u; h++) {
        const { valid: d, expectedType: p } = _E(e, f[h]);
        c.push(p || ""), u = d;
      }
      if (!u) {
        q(bE(t, e, c));
...
function Sf(t, e, n, r, i = !1) {
  ...
  if (u != null && u !== l && (rt(u) ? (f[u] = null, Ae(c, u) && (c[u] = null)) : Ye(u) && (u.value = null)), pe(l))
    Fr(l, o, 12, [a, f]);
  else {
    const h = rt(l), d = Ye(l);
    if (h || d) {
      const p = () => {
        if (t.f) {
          ...
          i ? le(m) && ah(m, s) : le(m) ? m.includes(s) || m.push(s) : h ? (f[l] = [s], Ae(c, l) && (c[l] = f[l])) : (l.value = [s], t.k && (f[t.k] = l.value));
        } else
...
function TE(t, e) {
  ...
  const {
  ...
  } = t, m = (_, S, A, V = null, j = null, W = null, Z = void 0, B = null, X = process.env.NODE_ENV !== "production" && vi ? !1 : !!S.dynamicChildren) => {
    if (_ === S)
      return;
    ...
    if (X = _.el = a(
      ...
      Z,
      B
    ), he && Ri(_, null, V, "created"), L(X, _, _.scopeId, Z, V), ne) {
      for (const $e in ne)
        $e !== "value" && !La($e) && s(
          X,
          $e,
    ...
    if (process.env.NODE_ENV !== "production" && B.type.__hmrId && v1(B), process.env.NODE_ENV !== "production" && (_l(_), Ar(B, "mount")), po(_) && (B.ctx.renderer = Pt), process.env.NODE_ENV !== "production" && Ar(B, "init"), GE(B), process.env.NODE_ENV !== "production" && Dr(B, "init"), B.asyncDep) {
    ...
    const B = () => {
      if (_.isMounted) {
        ...
        const zt = _.subTree;
        _.subTree = pt, process.env.NODE_ENV !== "production" && Ar(_, "patch"), m(
          zt,
          pt,
          c(zt.el),
          tn(zt),
          ...
          j,
          W
        ), process.env.NODE_ENV !== "production" && Dr(_, "patch"), ne.el = pt.el, $e === null && D1(_, pt.el), ae && on(ae, j), (Je = ne.props && ne.props.onVnodeUpdated) && on(
          () => nr(Je, he, ne, xe),
          j
        ...
        if ($i(_, !1), he && ca(he), !Je && (ne = ae && ae.onVnodeBeforeMount) && nr(ne, $e, S), $i(_, !0), ue && Tr) {
          ...
          process.env.NODE_ENV !== "production" && Dr(_, "render"), process.env.NODE_ENV !== "production" && Ar(_, "patch"), m(
            null,
            pt,
            A,
            V,
    ...
    if (U > ue) {
      ...
      for (U = he; U <= ue; U++) {
        ...
        nn === void 0 ? Te(ut, j, W, !0) : (tr[nn - xe] = U + 1, nn >= Di ? Di = nn : Nr = !0, m(
          ut,
          S[nn],
          A,
          null,
...
function Da(t, e, n = !1) {
  ...
  if (le(r) && le(i))
    for (let s = 0; s < r.length; s++) {
      const a = r[s];
      let o = i[s];
      o.shapeFlag & 1 && !o.dynamicChildren && ((o.patchFlag <= 0 || o.patchFlag === 32) && (o = i[s] = ai(i[s]), o.el = a.el), n || Da(a, o)), o.type === mo && (o.el = a.el), process.env.NODE_ENV !== "production" && o.type === Nt && !o.el && (o.el = a.el);
    }
}
function CE(t) {
  const e = t.slice(), n = [0];
...
const PE = (t) => t.__isTeleport, Us = (t) => t && (t.disabled || t.disabled === ""), Gd = (t) => typeof SVGElement < "u" && t instanceof SVGElement, Ud = (t) => typeof MathMLElement == "function" && t instanceof MathMLElement, wf = (t, e) => {
  ...
  process(t, e, n, r, i, s, a, o, l, u) {
    ...
    if (process.env.NODE_ENV !== "production" && vi && (l = !1, E = null), t == null) {
      ...
      d(O, n, r), d(N, n, r);
      const M = e.target = wf(e.props, p), L = e.targetAnchor = m("");
      M ? (d(L, M), a === "svg" || Gd(M) ? a = "svg" : (a === "mathml" || Ud(M)) && (a = "mathml")) : process.env.NODE_ENV !== "production" && !y && q("Invalid Teleport target on mount:", M, `(${typeof M})`);
      const I = (C, R) => {
        v & 16 && f(
          b,
          C,
      ...
      e.el = t.el;
      const O = e.anchor = t.anchor, N = e.target = t.target, M = e.targetAnchor = t.targetAnchor, L = Us(t.props), I = L ? n : N, C = L ? O : M;
      if (a === "svg" || Gd(N) ? a = "svg" : (a === "mathml" || Ud(N)) && (a = "mathml"), E ? (h(
        ...
        L ? e.props && t.props && e.props.to !== t.props.to && (e.props.to = t.props.to) : Wo(
          e,
          n,
          O,
          u,
...
function Wy(t, e = null, n = null, r = 0, i = null, s = !1) {
  ...
  const a = rt(t) ? 1 : F1(t) ? 128 : PE(t) ? 64 : Be(t) ? 4 : pe(t) ? 2 : 0;
...
function VE(t, e, n) {
  ...
  return process.env.NODE_ENV !== "production" ? s.ctx = nE(s) : s.ctx = { _: s }, s.root = e ? e.root : s, s.emit = P1.bind(null, s), t.ce && t.ce(s), s;
}
let St = null;
const go = () => St || ht;
let Zl, xf;
...
function Uu(t) {
  if (t.exposed)
    return t.exposeProxy || (t.exposeProxy = new Proxy(ny(pi(t.exposed)), {
      get(e, n) {
        if (n in e)
          return e[n];
        if (n in rs)
...
function JE(t) {
  ...
  const {
    ...
    Fi(T, [Q, $]), Kd(() => {
      Vi(Q, D ? l : s), Qr(Q, D ? f : o), Xd(T) || Zd(Q, r, m, $);
    });
  };
  return Qe(e, {
    onBeforeEnter(D) {
...
const ep = Symbol("_vod"), iS = Symbol("_vsh");
process.env.NODE_ENV;
...
function oS(t, e, n) {
  ...
  ep in t && (t[ep] = s ? r.display : "", t[iS] && (r.display = "none"));
}
const lS = /[^\\];\s*$/, tp = /\s*!important$/;
function wl(t, e, n) {
  if (le(n))
...
const op = (t) => t.charCodeAt(0) === 111 && t.charCodeAt(1) === 110 && t.charCodeAt(2) > 96 && t.charCodeAt(2) < 123, bS = (t, e, n, r, i, s, a, o, l) => {
  const u = i === "svg";
  e === "class" ? rS(t, r, u) : e === "style" ? oS(t, n, r) : co(e) ? Gl(e) || pS(t, e, n, r, a) : (e[0] === "." ? (e = e.slice(1), !0) : e[0] === "^" ? (e = e.slice(1), !1) : ES(t, e, r, u)) ? fS(
    t,
    e,
    r,
    s,
...
var $S = Object.hasOwnProperty, cp = Object.setPrototypeOf, FS = Object.isFrozen, VS = Object.getPrototypeOf, jS = Object.getOwnPropertyDescriptor, en = Object.freeze, An = Object.seal, GS = Object.create, Jy = typeof Reflect < "u" && Reflect, Jl = Jy.apply, Cf = Jy.construct;
...
var US = Dn(Array.prototype.forEach), fp = Dn(Array.prototype.pop), da = Dn(Array.prototype.push), Ol = Dn(String.prototype.toLowerCase), yc = Dn(String.prototype.toString), hp = Dn(String.prototype.match), Rn = Dn(String.prototype.replace), BS = Dn(String.prototype.indexOf), WS = Dn(String.prototype.trim), Ft = Dn(RegExp.prototype.test), vc = qS(TypeError);
function Dn(t) {
  return function(e) {
...
function Qy() {
  ...
  var E = sw(d, n), O = E ? E.createHTML("") : "", N = r, M = N.implementation, L = N.createNodeIterator, I = N.createDocumentFragment, C = N.getElementsByTagName, R = n.importNode, D = {};
  try {
  ...
  var ve = YS, T = XS, $ = KS, z = ZS, K = JS, Ce = ew, Le = tw, dt = rw, Rt = QS, Te = null, Ct = Pe({}, [].concat(Gn(dp), Gn(_c), Gn(bc), Gn(Ec), Gn(pp))), it = null, Jn = Pe({}, [].concat(Gn(mp), Gn(Sc), Gn(gp), Gn(Ho))), De = Object.seal(Object.create(null, {
    tagNameCheck: {
      writable: !0,
      configurable: !1,
      enumerable: !0,
  ...
  })), tn = null, Qn = null, Mr = !0, Pt = !0, er = !1, Tr = !0, _ = !1, S = !0, A = !1, V = !1, j = !1, W = !1, Z = !1, B = !1, X = !0, U = !1, ne = "user-content-", ue = !0, ae = !1, he = {}, xe = null, $e = Pe({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "noscript", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]), Je = null, pt = Pe({}, ["audio", "video", "img", "source", "image", "track"]), zt = null, Nr = Pe({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), Di = "http://www.w3.org/1998/Math/MathML", tr = "http://www.w3.org/2000/svg", bn = "http://www.w3.org/1999/xhtml", ut = bn, nn = !1, vs = null, V_ = Pe({}, [Di, tr, bn], yc), Ii, j_ = ["application/xhtml+xml", "text/html"], G_ = "text/html", Ot, _s = null, U_ = r.createElement("form"), id = function(w) {
    return w instanceof RegExp || w instanceof Function;
  }, ic = function(w) {
    _s && _s === w || ((!w || fi(w) !== "object") && (w = {}), w = ji(w), Ii = j_.indexOf(w.PARSER_MEDIA_TYPE) === -1 ? Ii = G_ : Ii = w.PARSER_MEDIA_TYPE, Ot = Ii === "application/xhtml+xml" ? yc : Ol, Te = "ALLOWED_TAGS" in w ? Pe({}, w.ALLOWED_TAGS, Ot) : Ct, it = "ALLOWED_ATTR" in w ? Pe({}, w.ALLOWED_ATTR, Ot) : Jn, vs = "ALLOWED_NAMESPACES" in w ? Pe({}, w.ALLOWED_NAMESPACES, yc) : V_, zt = "ADD_URI_SAFE_ATTR" in w ? Pe(
      ji(Nr),
      w.ADD_URI_SAFE_ATTR,
      Ot
    ) : Nr, Je = "ADD_DATA_URI_TAGS" in w ? Pe(
      ji(pt),
      w.ADD_DATA_URI_TAGS,
      Ot
    ) : pt, xe = "FORBID_CONTENTS" in w ? Pe({}, w.FORBID_CONTENTS, Ot) : $e, tn = "FORBID_TAGS" in w ? Pe({}, w.FORBID_TAGS, Ot) : {}, Qn = "FORBID_ATTR" in w ? Pe({}, w.FORBID_ATTR, Ot) : {}, he = "USE_PROFILES" in w ? w.USE_PROFILES : !1, Mr = w.ALLOW_ARIA_ATTR !== !1, Pt = w.ALLOW_DATA_ATTR !== !1, er = w.ALLOW_UNKNOWN_PROTOCOLS || !1, Tr = w.ALLOW_SELF_CLOSE_IN_ATTR !== !1, _ = w.SAFE_FOR_TEMPLATES || !1, S = w.SAFE_FOR_XML !== !1, A = w.WHOLE_DOCUMENT || !1, W = w.RETURN_DOM || !1, Z = w.RETURN_DOM_FRAGMENT || !1, B = w.RETURN_TRUSTED_TYPE || !1, j = w.FORCE_BODY || !1, X = w.SANITIZE_DOM !== !1, U = w.SANITIZE_NAMED_PROPS || !1, ue = w.KEEP_CONTENT !== !1, ae = w.IN_PLACE || !1, Rt = w.ALLOWED_URI_REGEXP || Rt, ut = w.NAMESPACE || bn, De = w.CUSTOM_ELEMENT_HANDLING || {}, w.CUSTOM_ELEMENT_HANDLING && id(w.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (De.tagNameCheck = w.CUSTOM_ELEMENT_HANDLING.tagNameCheck), w.CUSTOM_ELEMENT_HANDLING && id(w.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (De.attributeNameCheck = w.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), w.CUSTOM_ELEMENT_HANDLING && typeof w.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (De.allowCustomizedBuiltInElements = w.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), _ && (Pt = !1), Z && (W = !0), he && (Te = Pe({}, Gn(pp)), it = [], he.html === !0 && (Pe(Te, dp), Pe(it, mp)), he.svg === !0 && (Pe(Te, _c), Pe(it, Sc), Pe(it, Ho)), he.svgFilters === !0 && (Pe(Te, bc), Pe(it, Sc), Pe(it, Ho)), he.mathMl === !0 && (Pe(Te, Ec), Pe(it, gp), Pe(it, Ho))), w.ADD_TAGS && (Te === Ct && (Te = ji(Te)), Pe(Te, w.ADD_TAGS, Ot)), w.ADD_ATTR && (it === Jn && (it = ji(it)), Pe(it, w.ADD_ATTR, Ot)), w.ADD_URI_SAFE_ATTR && Pe(zt, w.ADD_URI_SAFE_ATTR, Ot), w.FORBID_CONTENTS && (xe === $e && (xe = ji(xe)), Pe(xe, w.FORBID_CONTENTS, Ot)), ue && (Te["#text"] = !0), A && Pe(Te, ["html", "head", "body"]), Te.table && (Pe(Te, ["tbody"]), delete tn.tbody), en && en(w), _s = w);
  }, sd = Pe({}, ["mi", "mo", "mn", "ms", "mtext"]), ad = Pe({}, ["foreignobject", "desc", "title", "annotation-xml"]), B_ = Pe({}, ["title", "style", "font", "a", "script"]), Do = Pe({}, _c);
  Pe(Do, bc), Pe(Do, HS);
  var sc = Pe({}, Ec);
  Pe(sc, zS);
  var W_ = function(w) {
    ...
    if (!Te[re] || tn[re]) {
      ...
      if (ue && !xe[re]) {
        ...
        if (rn && Fe)
          for (var $t = rn.length, Lt = $t - 1; Lt >= 0; --Lt)
            Fe.insertBefore(m(rn[Lt], !0), g(w));
      }
      return In(w), !0;
    }
    ...
    if (!!$t) {
      ...
      for (rn = $t.length; rn--; ) {
        ...
        if (re = Mt === "value" ? Y.value : WS(Y.value), Fe = Ot(Mt), Lt.attrName = Fe, Lt.attrValue = re, Lt.keepAttr = !0, Lt.forceKeepAttr = void 0, Cr("uponSanitizeAttribute", w, Lt), re = Lt.attrValue, !Lt.forceKeepAttr && (ac(Mt, w), !!Lt.keepAttr)) {
          if (!Tr && Ft(/\/>/i, re)) {
            ac(Mt, w);
            continue;
          }
...
function pw() {
  var t;
  return bs !== void 0 || (typeof window < "u" && window.performance ? (bs = !0, Pf = window.performance) : typeof globalThis < "u" && ((t = globalThis.perf_hooks) === null || t === void 0 ? void 0 : t.performance) ? (bs = !0, Pf = globalThis.perf_hooks.performance) : bs = !1), bs;
}
function mw() {
  return pw() ? Pf.now() : Date.now();
}
class gw {
  constructor(e, n) {
...
const cv = "\u{1F34D} Pinia (root)", Lf = "_root";
function Mw(t) {
  return Ph(t) ? {
    id: Lf,
    label: cv
...
function Lw(t, e) {
  nv({
    ...
    typeof n.now != "function" && Tt("You seem to be using an outdated version of Vue Devtools. Are you still using the Beta release instead of the stable one? You can find the links at https://devtools.vuejs.org/guide/installation.html."), n.addTimelineLayer({
      ...
      if (r.app === t && r.inspectorId === Gt) {
        const i = r.nodeId === Lf ? e : e._s.get(r.nodeId);
        if (!i)
          return;
        i && (r.state = Tw(i));
      }
      ...
      if (r.app === t && r.inspectorId === Gt) {
        const s = r.nodeId === Lf ? e : e._s.get(r.nodeId);
        if (!s)
          return Tt(`store "${r.nodeId}" not found`, "error");
        const { path: a } = r;
        Ph(s) ? a.unshift("state") : (a.length !== 1 || !s._customProperties.has(a[0]) || a[0] in s.$state) && a.unshift("$state"), Ls = !1, r.set(s, a, r.state.value), Ls = !0;
      }
...
Only state can be modified.`);
        a[0] = "$state", Ls = !1, r.set(s, a, r.state.value), Ls = !0;
      }
    });
  });
}
function kw(t, e) {
  Nl.includes(Ql(e.$id)) || Nl.push(Ql(e.$id)), nv({
    ...
    e.$onAction(({ after: a, onError: o, name: l, args: u }) => {
      ...
      et(() => x(e[a]), (o, l) => {
        n.notifyComponentUpdate(), n.sendInspectorState(Gt), Ls && n.addTimelineEvent({
          layerId: zi,
          event: {
            time: r(),
            title: "Change",
      ...
      if (n.notifyComponentUpdate(), n.sendInspectorState(Gt), !Ls)
        return;
      const u = {
        time: r(),
        title: Cw(o),
        data: Pw({ store: Un(e.$id) }, Nw(a)),
        groupId: mi
      };
...
function Dw() {
  ...
  const i = pi({
    install(s) {
      eo(i), i._a = s, s.provide(rv, i), s.config.globalProperties.$pinia = i, Ra && Lw(s, i), r.forEach((a) => n.push(a)), r = [];
    },
    use(s) {
...
function Af(t, e, n = {}, r, i, s) {
  ...
  const O = /* @__PURE__ */ pi({
    ...
    $reset: v,
    $subscribe(C, R = {}) {
      const D = _p(c, C, R.detached, () => Q()), Q = a.run(() => et(() => r.state.value[t], (ve) => {
        (R.flush === "sync" ? f : u) && C({
          storeId: t,
          type: dr.direct,
          events: d
  ...
  for (const C in I) {
    const R = I[C];
    if (Ye(R) && !bp(R) || hr(R))
      process.env.NODE_ENV !== "production" && i ? zo(m.value, C, vl(I, C)) : s || (p && $w(R) && (Ye(R) ? R.value = p[C] : kf(R, p[C])), r.state.value[t][C] = R), process.env.NODE_ENV !== "production" && O.state.push(C);
...
This will fail in production.`);
    o = Sa, o._s.has(r) || (s ? Af(r, e, i, o) : Ep(r, i, o), process.env.NODE_ENV !== "production" && (a._pinia = o));
    const f = o._s.get(r);
    if (process.env.NODE_ENV !== "production" && l) {
      const c = "__hot:" + r, h = s ? Af(c, e, i, o, !0) : Ep(c, wn({}, i), o, !0);
...
var cs = 1, fs = 2, Bs = 3, Vw = 4, Df = 5, Sp = 6378137, jw = 6356752314e-3, wp = 0.0066943799901413165, $a = 484813681109536e-20, H = Math.PI / 2, Gw = 0.16666666666666666, Uw = 0.04722222222222222, Bw = 0.022156084656084655, te = 1e-10, At = 0.017453292519943295, ur = 57.29577951308232, We = Math.PI / 4, to = Math.PI * 2, gt = 3.14159265359, cn = {};
cn.greenwich = 0;
...
var no = 1, pv = 2, mv = 3, eu = 4, gv = 5, Lh = -1, qw = /\s/, Hw = /[A-Za-z]/, zw = /[A-Za-z84_]/, Hu = /[,\]]/, yv = /[\d\.E\-\+]/;
function Xr(t) {
  if (typeof t != "string")
...
Xr.prototype.afterItem = function(t) {
  ...
  if (t === "]") {
    this.level--, this.word !== null && (this.currentObject.push(this.word), this.word = null), this.state = no, this.currentObject = this.stack.pop(), this.currentObject || (this.state = Lh);
    return;
  }
};
...
function Nx(t, e, n) {
  for (var r = 176, i = [], s = 0; s < e.nSubgrids; s++) {
    var a = Px(t, r, n), o = Lx(t, r, a, n), l = Math.round(
...
function Sv(t, e, n, r) {
  var i = 1e-12, s = i * i, a = 30, o, l, u, f, c, h, d, p, m, g, y, v, b, E = t.x, O = t.y, N = t.z ? t.z : 0, M, L, I;
  ...
  while (v * v > s && b < a);
  return L = Math.atan(y / Math.abs(g)), {
    x: M,
    y: L,
    z: I
  };
...
function Ix(t, e, n) {
  ...
  if (e.datum_type === Bs && (a = Sp, o = jw, l = wp), i === l && r === a && !Yo(t.datum_type) && !Yo(e.datum_type))
    return n;
  ...
  e:
    for (var a = 0; a < t.grids.length; a++) {
      ...
      for (var l = o.grid.subgrids, u = 0, f = l.length; u < f; u++) {
        ...
        if (!(p > r.y || d > r.x || g < r.y || m < r.x) && (i = Rx(r, e, c), !isNaN(i.x)))
          break e;
      }
    }
...
function nu(t, e, n, r) {
  ...
  var s = n.z !== void 0;
  if ($x(n), t.datum && e.datum && Fx(t, e) && (i = new pr("WGS84"), n = nu(t, i, n, r), t = i), r && t.axis !== "enu" && (n = Pp(t, !1, n)), t.projName === "longlat")
    n = {
      x: n.x * At,
      y: n.y * At,
      z: n.z || 0
...
function qt(t, e, n) {
  t = Ap(t);
  var r = !1, i;
  return typeof e > "u" ? (e = t, t = kp, r = !0) : (typeof e.x < "u" || Array.isArray(e)) && (n = e, e = t, t = kp, r = !0), e = Ap(e), n ? xc(t, e, n) : (i = {
...
var Dp = 6, xv = "AJSAJS", Ov = "AFAFAF", Ds = 65, an = 73, xn = 79, wa = 86, xa = 90;
const Vx = {
  forward: Mv,
  inverse: jx,
  toPoint: Tv
...
var Xx = 1, Kx = 0.25, Rp = 0.046875, $p = 0.01953125, Fp = 0.01068115234375, Zx = 0.75, Jx = 0.46875, Qx = 0.013020833333333334, eO = 0.007120768229166667, tO = 0.3645833333333333, nO = 0.005696614583333333, rO = 0.3076171875;
function Pv(t) {
  var e = [];
  e[0] = Xx - t * (Kx + t * (Rp + t * ($p + t * Fp))), e[1] = t * (Zx - t * (Rp + t * ($p + t * Fp)));
  var n = t * t;
...
function oO(t) {
  ...
  if (this.es)
    if (e = this.ml0 + a / this.k0, n = Lv(e, this.es, this.en), Math.abs(n) < H) {
...
function Av(t, e, n) {
  for (var r = Math.sin(e), i = Math.cos(e), s = kv(n), a = hO(n), o = 2 * i * a, l = -2 * r * s, u = t.length - 1, f = t[u], c = 0, h = 0, d = 0, p, m; --u >= 0; )
...
function dO() {
  ...
  this.approx && (Pl.init.apply(this), this.forward = Pl.forward, this.inverse = Pl.inverse), this.x0 = this.x0 !== void 0 ? this.x0 : 0, this.y0 = this.y0 !== void 0 ? this.y0 : 0, this.long0 = this.long0 !== void 0 ? this.long0 : 0, this.lat0 = this.lat0 !== void 0 ? this.lat0 : 0, this.cgb = [], this.cbg = [], this.utg = [], this.gtu = [];
...
function _O() {
  ...
  this.lat0 = 0, this.long0 = (6 * Math.abs(t) - 183) * At, this.x0 = 5e5, this.y0 = this.utmSouth ? 1e7 : 0, this.k0 = 0.9996, Ll.init.apply(this), this.forward = Ll.forward, this.inverse = Ll.inverse;
}
...
function bN(t) {
  t.Proj.projections.add(Pl), t.Proj.projections.add(Ll), t.Proj.projections.add(EO), t.Proj.projections.add(LO), t.Proj.projections.add($O), t.Proj.projections.add(UO), t.Proj.projections.add(YO), t.Proj.projections.add(QO), t.Proj.projections.add(iM), t.Proj.projections.add(uM), t.Proj.projections.add(MM), t.Proj.projections.add(kM), t.Proj.projections.add($M), t.Proj.projections.add(BM), t.Proj.projections.add(YM), t.Proj.projections.add(QM), t.Proj.projections.add(iT), t.Proj.projections.add(uT), t.Proj.projections.add(mT), t.Proj.projections.add(bT), t.Proj.projections.add(OT), t.Proj.projections.add(PT), t.Proj.projections.add(IT), t.Proj.projections.add(jT), t.Proj.projections.add(qT), t.Proj.projections.add(QT), t.Proj.projections.add(iN), t.Proj.projections.add(uN), t.Proj.projections.add(pN), t.Proj.projections.add(_N);
}
...
const xN = io.INFO, ON = 7e3, MN = 4e3, au = ps(
  "alert-notifications",
  () => {
    const t = we([]);
    function e(r, i = xN, s) {
  ...
  for (const [r, i] of e)
    n[r] = i;
  return n;
}, NN = /* @__PURE__ */ me(TN, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/alert-notifications/notification-item.vue"]]), CN = {
  key: 0,
...
}), LN = /* @__PURE__ */ me(PN, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/alert-notifications/alert-notifications.vue"]]), kN = { class: "lux-dropdown" }, AN = { class: "h-full" }, DN = ["aria-expanded"], IN = /* @__PURE__ */ P("span", { class: "lux-caret" }, null, -1), RN = { class: "lux-dropdown-wrapper" }, $N = ["aria-label", "data-value"], FN = /* @__PURE__ */ fe({
      ...
      return k(), G("div", kN, [
        ...
        P("div", RN, [
          P("ul", {
            ...
            (k(!0), G(Ge, null, kn(n.options, (p) => (k(), G("li", {
              key: p.value,
...
}), $v = /* @__PURE__ */ me(FN, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/dropdown-list.vue"]]), Ua = "EPSG:3857", Fv = "EPSG:4326", VN = "EPSG:2169";
let Mc;
const jp = tt();
function Vr() {
  function t() {
...
var r2 = function(t) {
  ...
  return Or(n, [{
    ...
    value: function(i, s, a, o, l) {
      ...
      var c = ou(this.data, f) || {};
      o ? jv(c, a, l) : c = Ko(Ko({}, c), a), Hp(this.data, f, c), u.silent || this.emit("added", i, s, a);
    }
  }, {
...
var Xp = {}, Kp = function(t) {
  ...
  return Or(n, [{
    ...
    value: function(i, s, a) {
      var o = this;
      if (Pn(s) !== "object" && this.options.overloadTranslationOptionHandler && (s = this.options.overloadTranslationOptionHandler(arguments)), Pn(s) === "object" && (s = Vt({}, s)), s || (s = {}), i == null)
        return "";
      ...
      var y = this.resolve(i, s), v = y && y.res, b = y && y.usedKey || c, E = y && y.exactUsedKey || c, O = Object.prototype.toString.apply(v), N = ["[object Number]", "[object Function]", "[object RegExp]"], M = s.joinArrays !== void 0 ? s.joinArrays : this.options.joinArrays, L = !this.i18nFormat || this.i18nFormat.handleAsObject, I = typeof v != "string" && typeof v != "boolean" && typeof v != "number";
      if (L && v && I && N.indexOf(O) < 0 && !(typeof M == "string" && O === "[object Array]")) {
      ...
      } else if (L && typeof M == "string" && O === "[object Array]")
        v = v.join(M), v && (v = this.extendTranslation(v, i, s, a));
      else {
        var $ = !1, z = !1, K = s.count !== void 0 && typeof s.count != "string", Ce = n.hasDefaultValue(s), Le = K ? this.pluralResolver.getSuffix(p, s.count, s) : "", dt = s["defaultValue".concat(Le)] || s.defaultValue;
        ...
        if (z || $ || Ct) {
          ...
          var Qn = function(Pt, er, Tr) {
            var _ = Ce && Tr !== v ? Tr : Te;
            o.options.missingKeyHandler ? o.options.missingKeyHandler(Pt, d, er, _, Ct, s) : o.backendConnector && o.backendConnector.saveMissing && o.backendConnector.saveMissing(Pt, d, er, _, Ct, s), o.emit("missingKey", Pt, d, er, v);
          };
          this.options.saveMissing && (this.options.saveMissingPlurals && K ? Jn.forEach(function(Mr) {
            o.pluralResolver.getSuffixes(Mr, s).forEach(function(Pt) {
              Qn([Mr], c + Pt, s["defaultValue".concat(Pt)] || dt);
            });
          }) : Qn(Jn, c, dt));
        }
      ...
      var s = this, a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, o = r.split(this.formatSeparator), l = o.reduce(function(u, f) {
        ...
        if (s.formats[h]) {
          ...
          try {
            ...
            p = s.formats[h](u, g, Lr(Lr(Lr({}, d), a), m));
          } catch (y) {
            s.logger.warn(y);
          }
          return p;
...
function im() {
  return {
    ...
    overloadTranslationOptionHandler: function(e) {
      var n = {};
      if (Pn(e[1]) === "object" && (n = e[1]), typeof e[1] == "string" && (n.defaultValue = e[1]), typeof e[2] == "string" && (n.tDescription = e[2]), Pn(e[2]) === "object" || Pn(e[3]) === "object") {
        var r = e[3] || e[2];
...
function S2(t, {
  ...
  n.forEach((h) => {
    ...
    beforeCreate() {
      ...
      this.__bundles = [];
      const v = (M) => {
        Object.entries(M).forEach(([L, I]) => {
          e.addResourceBundle(L, y, I, !0, !1), this.__bundles.push([L, y]);
        });
      };
      ...
      const N = u(b, E);
      this.__translate = (M, L) => !O || f(M) ? N(M, L) : N(O + "." + M, L);
    },
    unmounted() {
      var h;
...
class z2 {
  constructor(e, n, r) {
    this.opts = { style: "long", ...r }, !n && m0() && (this.rtf = $2(e, r));
  }
  format(e, n) {
...
class Xe {
  ...
  static create(e, n, r, i, s = !1) {
    const a = e || mt.defaultLocale, o = a || (s ? "en-US" : F2()), l = n || mt.defaultNumberingSystem, u = r || mt.defaultOutputCalendar, f = Wf(i) || mt.defaultWeekSettings;
...
const N0 = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/, mC = `(?:${N0.source}?(?:\\[(${M0.source})\\])?)?`, Uh = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/, C0 = RegExp(`${Uh.source}${mC}`), Bh = RegExp(`(?:T${C0.source})?`), gC = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, yC = /(\d{4})-?W(\d\d)(?:-?(\d))?/, vC = /(\d{4})-?(\d{3})/, _C = T0("weekYear", "weekNumber", "weekDay"), bC = T0("year", "ordinal"), EC = /(\d{4})-(\d\d)-(\d\d)/, P0 = RegExp(
...
const IC = ia(gC, Bh), RC = ia(yC, Bh), $C = ia(vC, Bh), FC = ia(C0), L0 = sa(
  wC,
  oa,
  Mo,
  To
...
const YC = ia(EC, SC), XC = ia(P0), KC = sa(
  oa,
  Mo,
  To
);
...
class Re {
  ...
  rescale() {
    if (!this.isValid)
      return this;
    const e = tP(this.normalize().shiftToAll().toObject());
...
class el {
  ...
  static features() {
    return { relative: m0(), localeWeek: g0() };
  }
}
function Mm(t, e) {
...
function Ve(t, e = (n) => n) {
  return { regex: t, deser: ([n]) => e(aP(n)) };
}
const lP = String.fromCharCode(160), D0 = `[ ${lP}]`, I0 = new RegExp(D0, "g");
function uP(t) {
...
function fP(t, e) {
  const n = Fn(e), r = Fn(e, "{2}"), i = Fn(e, "{3}"), s = Fn(e, "{4}"), a = Fn(e, "{6}"), o = Fn(e, "{1,2}"), l = Fn(e, "{1,3}"), u = Fn(e, "{1,6}"), f = Fn(e, "{1,9}"), c = Fn(e, "{2,4}"), h = Fn(e, "{4,6}"), d = (g) => ({ regex: RegExp(cP(g.val)), deser: ([y]) => y, literal: !0 }), m = ((g) => {
    if (t.literal)
      return d(g);
    switch (g.val) {
      case "G":
...
let Lc = null;
function yP() {
  return Lc || (Lc = Oe.fromMillis(1555555555555)), Lc;
}
function vP(t, e) {
  if (t.literal)
    return t;
...
function R0(t, e) {
  return Array.prototype.concat(...t.map((n) => vP(n, e)));
}
function $0(t, e, n) {
  const r = R0(Wt.parseFormat(n), t), i = r.map((a) => fP(a, t)), s = i.find((a) => a.invalidReason);
  if (s)
    return { input: e, tokens: r, invalidReason: s.invalidReason };
  {
    const [a, o] = pP(i), l = RegExp(a, "i"), [u, f] = mP(e, l, o), [c, h, d] = f ? gP(f) : [null, null, void 0];
    if (ea(f, "a") && ea(f, "H"))
      throw new Rs(
...
function F0(t, e) {
  if (!t)
    return null;
  const r = Wt.create(e, t).dtFormatter(yP()), i = r.formatToParts(), s = r.resolvedOptions();
  return i.map((a) => dP(a, t, s));
}
...
const j0 = {
  ...
  second: 0,
  millisecond: 0
}, G0 = ["year", "month", "day", "hour", "minute", "second", "millisecond"], SP = [
  "weekYear",
  "weekNumber",
  "weekday",
  "hour",
...
class Oe {
  ...
  static local() {
    ...
    return Dm({ year: r, month: i, day: s, hour: a, minute: o, second: l, millisecond: u }, e);
  }
  static utc() {
    const [e, n] = Rm(arguments), [r, i, s, a, o, l, u] = n;
    return e.zone = Qt.utcInstance, Dm({ year: r, month: i, day: s, hour: a, minute: o, second: l, millisecond: u }, e);
  }
  ...
  static fromObject(e, n = {}) {
    ...
    const i = Xe.fromObject(n), s = du(e, Am), { minDaysInFirstWeek: a, startOfWeek: o } = _m(s, i), l = mt.now(), u = Se(n.specificOffset) ? r.offset(l) : n.specificOffset, f = !Se(s.ordinal), c = !Se(s.year), h = !Se(s.month) || !Se(s.day), d = c || h, p = s.weekYear || s.weekNumber;
    if ((d || f) && p)
      throw new Rs(
    ...
    let g, y, v = rl(l, u);
    m ? (g = SP, y = bP, v = fu(v, a, o)) : f ? (g = wP, y = EP, v = Pc(v)) : (g = G0, y = j0);
    let b = !1;
    for (const C of g) {
      const R = s[C];
      Se(R) ? b ? s[C] = y[C] : s[C] = v[C] : b = !0;
    }
    const E = m ? K2(s, a, o) : f ? Z2(s) : d0(s), O = E || p0(s);
    if (O)
      return Oe.invalid(O);
    const N = m ? ym(s, a, o) : f ? vm(s) : s, [M, L] = Dl(N, u, r), I = new Oe({
      ts: M,
      zone: r,
      o: L,
      loc: i
  ...
  get ordinal() {
    return this.isValid ? Pc(this.c).ordinal : NaN;
  }
  get monthShort() {
  ...
  set(e) {
    if (!this.isValid)
      return this;
    const n = du(e, Am), { minDaysInFirstWeek: r, startOfWeek: i } = _m(n, this.loc), s = !Se(n.weekYear) || !Se(n.weekNumber) || !Se(n.weekday), a = !Se(n.ordinal), o = !Se(n.year), l = !Se(n.month) || !Se(n.day), u = o || l, f = n.weekYear || n.weekNumber;
    if ((u || a) && f)
      throw new Rs(
        "Can't mix weekYear/weekNumber units with year/month/day or ordinals"
      );
    ...
    s ? c = ym(
      ...
      r,
      i
    ) : Se(n.ordinal) ? (c = { ...this.toObject(), ...n }, Se(n.day) && (c.day = Math.min(hu(c.year, c.month), c.day))) : c = vm({ ...Pc(this.c), ...n });
  ...
  toISO({
    ...
    const a = e === "extended";
    let o = Ic(this, a);
    return o += "T", o += km(this, a, n, r, i, s), o;
  }
  ...
  diff(e, n = "milliseconds", r = {}) {
    ...
    const i = { locale: this.locale, numberingSystem: this.numberingSystem, ...r }, s = eC(n).map(Re.normalizeUnit), a = e.valueOf() > this.valueOf(), o = a ? this : e, l = a ? e : this, u = iP(o, l, s, i);
    return a ? u.negate() : u;
  }
...
function OP(t, e) {
  return t <= e.minValue ? e.minValue : t >= e.maxValue ? e.maxValue : e.timeValueList ? MP(t, e) : TP(t, e);
}
function MP(t, e) {
  var l;
...
function Kn() {
  ...
  function o(l, u = !0, f) {
    var m;
    const c = Zt(), h = vt(), d = f ? c.layerTrees_3d : c.theme, p = Fm.findById(l, d);
    if (p) {
...
mr(/Edge/i);
const No = "ipv6", Co = "applogin", Po = "localforage", Ys = "debug", pu = "fid", wi = "lang", mu = "layersOpen", gu = "address", zf = "version", DP = "map_id", jm = "layers", Gm = "bgLayer", Um = "opacities", ao = "theme", Bm = "time", Wm = "zoom", IP = "SRS", qm = "X", Hm = "Y", yu = "serial", W0 = [
  "basemap_2015_global",
  "topogr_global",
  "topo_bw_jpeg"
], Yf = "lc", Xf = "sliderRatio", q0 = "bgOpacity", RP = "layers_indices", zm = "layers_opacity", Ym = "layers_visibility";
...
class vu extends H0 {
  ...
  static ruleUseLocalStorage(e) {
    return [$P, FP, VP].reduce(
      (n, r) => n || r(e),
      !1
    );
  }
}
const $P = (t) => Object.keys(t).length === 0, FP = (t) => Object.keys(t).length === 1 && (t.hasOwnProperty(No) || t.hasOwnProperty(Co) || t.hasOwnProperty(Po)), VP = (t) => Object.keys(t).length === 3 && t.hasOwnProperty(No) && t.hasOwnProperty(Co) && t.hasOwnProperty(Po);
class _u extends H0 {
  static processRules() {
...
const jP = (t) => t === Yf || t === Xf, GP = (t) => t === zf, UP = (t) => t === ao && {}.VITE_DEPLOY_GHPAGES === "true";
class z0 {
  constructor() {
    st(this, "snappedUrl");
...
const al = new qP();
function HP(t) {
  return zP(t) || YP(t) || XP(t) || KP(t);
}
const zP = (t) => Object.keys(t).length === 0, YP = (t) => {
  ...
  const e = Object.keys(t), n = (a) => e.indexOf(a) !== -1, r = [No, Co, Po].every(
    n
...
class ZP {
  constructor() {
    ...
    this.intialVersion = n ? Math.max(2, Math.min(n, 3)) : HP(e) ? 3 : 2, this.setValue(zf, 3);
  }
  getInitialVersion() {
        ...
        v == null || v.layers.forEach((E, O) => {
          for (const N of JP)
            if ((b[`${N}s`] || []).includes(E.id)) {
              ...
              b.color && (L[`${N}-color`] = b.color, L[`${N}-opacity`] = 1, v.layers[O].paint = L), v.layers[O].layout = Object.assign(
                {},
                v.layers[O].layout,
...
const Y0 = new QP(), eL = "https://map.geoportail.lu/ogcproxywms", tL = "https://map.geoportail.lu/httpsproxy";
class nL {
  constructor() {
    st(this, "_wmsProxyUrl", eL);
    st(this, "_remoteProxyUrl", tL);
  }
  get wmsProxyUrl() {
...
function e_() {
  ...
  function h(d, p, m) {
    ...
    let b;
    p && (o(p) ? b = f(p) : (b = Xm.createOlLayer(
      p,
      m
    ), l(p.id, b))), y >= 0 ? b ? (b.setZIndex(ol), g.setAt(y, b)) : g.removeAt(y) : b && (b.setZIndex(ol), d.addLayer(b)), v && v !== (p == null ? void 0 : p.id) && Y0.restoreStyle(!0);
  }
  return {
    addLayer: t,
    findLayer: e,
...
class mL {
  ...
  persistZoom() {
    const e = Vr().getOlMap().getView(), n = () => {
      const r = e.getZoom();
      Ne.setValue(Wm, r ? Math.ceil(r) : null);
    };
    n(), gd.listen(
      e,
      "change:resolution",
  ...
  persistXY() {
    const e = Vr().getOlMap().getView(), n = () => {
      const r = e.getCenter();
      Ne.setValue(qm, r ? Math.round(r[0]) : null), Ne.setValue(Hm, r ? Math.round(r[1]) : null);
    };
    n(), gd.listen(
      e,
      ob.PROPERTYCHANGE,
  ...
  restore() {
    const e = Vr().getOlMap().getView(), n = Ne.getValue(Wm, zs), r = Ne.getInitialVersion(), i = Ne.getValue(qm, zs), s = Ne.getValue(Hm, zs), a = Ne.getValue(IP), o = K_(
      VN,
      Ua
    );
    let l, u;
    n !== void 0 ? u = r === 3 ? Number(n) : pL[n] : u = 8, i != null && s != null ? r === 3 && a != null ? l = pd([i, s], a, Ua) : l = r === 3 ? [i, s] : o([s, i], void 0, 2) : l = pd(
      [6, 49.7],
      Fv,
      Ua
...
const gL = new mL(), yL = {
  ...
  setup(t) {
    ...
    return vn(() => {
      ...
      return n.value ? zl((k(), G("div", yL, null, 512)), [
        [s, n.value]
      ]) : F("v-if", !0);
    };
  }
}), _L = /* @__PURE__ */ me(vL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/attribution-control.vue"]]);
function Lo(t, e) {
...
const bL = ["title"], EL = /* @__PURE__ */ fe({
...
}), SL = /* @__PURE__ */ me(EL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/location-control.vue"]]), wL = ["title"], xL = /* @__PURE__ */ fe({
  __name: "map-3d",
  props: {
...
}), OL = /* @__PURE__ */ me(xL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/map-3d.vue"]]), ML = /* @__PURE__ */ fe({
  ...
  setup(t) {
    return Lo(lb, t), (n, r) => F("v-if", !0);
  }
}), TL = /* @__PURE__ */ me(ML, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/fullscreen-control.vue"]]), NL = /* @__PURE__ */ fe({
  __name: "zoom-control",
  props: {
    className: { type: String, required: !1 },
  ...
  setup(t) {
    return Lo(ub, t), (n, r) => F("v-if", !0);
  }
}), CL = /* @__PURE__ */ me(NL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/zoom-control.vue"]]);
class PL extends cb {
  constructor(n) {
    super(n);
    st(this, "ol3dm");
...
const LL = /* @__PURE__ */ fe({
  ...
  setup(t) {
    return Lo(PL, t), (n, r) => F("v-if", !0);
  }
}), kL = /* @__PURE__ */ me(LL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map-controls/zoom-to-extent-control.vue"]]), AL = /* @__PURE__ */ fe({
  ...
  setup(t) {
    ...
    return _n(() => {
      ...
      ie(TL),
      ie(_L),
      s.v4_standalone ? (k(), Ue(OL, { key: 0 })) : F("v-if", !0),
      ie(SL)
    ], 512));
  }
}), DL = /* @__PURE__ */ me(AL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/map/map-container.vue"]]), IL = "fr", RL = !0, $L = !1, FL = !1, wt = ps(
  "app",
  () => {
    const t = we(IL), e = we(RL), n = we($L), r = we(FL), i = we(), s = we(), a = we(!1);
    function o(m) {
      t.value = m;
    }
    function l(m) {
...
const VL = ["title"], jL = /* @__PURE__ */ fe({
...
}), Km = /* @__PURE__ */ me(jL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/background-selector/background-selector-item.vue"]]), GL = {
  key: 0,
  ...
  setup(t) {
    ...
    return (p, m) => x(a) ? F("v-if", !0) : (k(), G("div", GL, [
      P("div", {
...
}), BL = /* @__PURE__ */ me(UL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/background-selector/background-selector.vue"]]), WL = /* @__PURE__ */ P("div", { class: "fixed inset-0 bg-gray-900 opacity-40 z-[1050]" }, null, -1), qL = { class: "bg-white shadow-modal rounded-lg overflow-hidden w-[700px]" }, HL = { class: "relative flex flex-row justify-center p-4 border-b-[1px]" }, zL = { class: "text-xl" }, YL = /* @__PURE__ */ P("span", { "aria-hidden": "true" }, "\xD7", -1), XL = [
  YL
], KL = {
  key: 0,
  class: "p-[15px] border-t-[1px]"
}, ZL = { class: "flex flex-row justify-end" }, JL = /* @__PURE__ */ fe({
  __name: "modal-dialog",
  props: {
    footer: {
      type: Boolean,
...
}), n_ = /* @__PURE__ */ me(JL, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/modal-dialog.vue"]]), zh = ps(
  "metadata",
  () => {
    const t = we();
    function e(r) {
  ...
  {}
), QL = ["aria-expanded"], ek = { class: "leading-6" }, tk = /* @__PURE__ */ fe({
...
}), Il = /* @__PURE__ */ me(tk, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/expandable-panel.vue"]]), nk = {
  class: "mb-px",
  key: "node.id"
    ...
    return (h, d) => {
      ...
      return a ? (k(), G("div", nk, [
        ...
        l ? F("v-if", !0) : (k(), G("div", {
          ...
          (k(!0), G(Ge, null, kn(h.node.children, (m) => (k(), Ue(p, {
            key: m.id,
            node: m,
        ...
        P("button", {
          ...
          P("span", uk, oe(u.value), 1)
        ], 10, lk)
      ]));
    };
  }
}), Kf = /* @__PURE__ */ me(ck, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-tree/layer-tree-node.vue"]]);
class fk {
  toggleNode(e, n, r) {
    var i;
...
function r_(t, e, n = 0) {
  const { name: r = "", type: i = Ln.WMS, children: s } = t, a = `${i}||${e}||${r}`.split("-").join("%2D"), o = vt();
  return {
    id: a,
    name: r,
    depth: n,
...
class Lk extends Bc {
  ...
  get root() {
    return this.children.find((e) => e instanceof Pk) || null;
  }
  get text() {
    return this.children.map((e) => "text" in e ? e.text : "").join("");
  }
...
var f_ = kk;
const Ak = bk, Bi = ki, Dk = l_, Ik = u_, Rk = c_, $k = Zh, Zm = f_, Jm = Xh, qc = "";
class Fk {
  constructor(e, n = {}) {
  ...
  consumeProcessingInstruction() {
    ...
    if (r ? r.toLowerCase() === "xml" && (e.reset(n), this.error("XML declaration isn't allowed here")) : this.error("Invalid processing instruction"), !this.consumeWhitespace()) {
      if (e.consumeStringFast("?>"))
        return this.addNode(new Zm(r)), !0;
      this.error("Whitespace is required after a processing instruction name");
    }
    let i = e.consumeUntilString("?>");
    return this.validateChars(i), e.consumeStringFast("?>") || this.error("Unterminated processing instruction"), this.addNode(new Zm(r, i)), !0;
  }
  consumeProlog() {
    let { scanner: e } = this, n = e.charIndex;
...
const Qm = ["utf-8", "utf-16", "iso-8859-1"], eg = "utf-8";
function Jk(t) {
  const e = /charset=([^;]+)/.exec(t);
  return e ? e[1] : null;
}
function Qk(t, e) {
  const n = e ? Jk(e) : null, r = n ? [n, ...Qm] : Qm;
  for (const i of r)
    try {
...
function d_(t, e, n = [], r = [], i = null) {
  ...
  function f(p) {
    const m = yr(p, s);
    return (fA(m) && e === "1.3.0" ? ["miny", "minx", "maxy", "maxx"] : ["minx", "miny", "maxx", "maxy"]).map((y) => yr(p, y));
  }
  const c = Me(t, "Attribution"), h = c !== null ? mA(c) : i, d = Ht(t, "Layer").map(
    (p) => d_(p, e, o, u, h)
  );
  return {
    name: ze(Me(t, "Name")),
...
const oo = new wA(), xA = { class: "relative text-center" }, OA = ["placeholder", "value"], MA = {
  ...
  key: 1,
  class: "text-center"
}, CA = { class: "lux-label" }, PA = {
  key: 2,
  class: "text-center"
}, LA = /* @__PURE__ */ P("div", { class: "fa fa-refresh fa-spin" }, null, -1), kA = {
  key: 3,
    ...
    return (E, O) => x(a) ? (k(), Ue(n_, {
      ...
      content: _i(() => {
        ...
        return [
          ...
          !x(l) && x(c) ? (k(), G("div", MA, [
            P("span", TA, oe(x(e)("Description du service :", {
              ns: "client"
            })), 1),
            Kl(" " + oe((N = x(c).getServiceInfo()) == null ? void 0 : N.abstract), 1)
          ])) : F("v-if", !0),
          !x(l) && x(c) ? (k(), G("div", NA, [
            P("span", CA, oe(x(e)("Access constraints :", {
              ns: "client"
            })), 1),
          ...
          x(l) ? (k(), G("div", PA, [
            LA,
            P("span", null, oe(x(e)("Chargement des informations", {
              ns: "client"
            })), 1)
          ])) : F("v-if", !0),
...
}), DA = /* @__PURE__ */ me(AA, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/remote-layers/remote-layers.vue"]]);
...
const RA = { class: "font-bold" }, $A = { class: "col-span-2" }, FA = /* @__PURE__ */ fe({
  ...
  setup(t) {
    ...
    return (n, r) => (k(), G(Ge, null, [
      P("span", RA, oe(e.label), 1),
      P("span", $A, oe(e.value), 1)
    ], 64));
  }
}), _a = /* @__PURE__ */ me(FA, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-metadata/layer-metadata-item.vue"]]);
function VA(t) {
  return {
    fr: "fre",
    en: "eng",
...
const tg = new XA(), KA = { class: "grid gap-2 grid-cols-3 pt-3 text-[13px] font-arial break-words" }, ZA = {
  ...
  key: 7,
  class: "col-span-3 grid gap-2 grid-cols-3"
}, oD = { class: "font-bold" }, lD = { class: "col-span-2" }, uD = { key: 0 }, cD = { key: 1 }, fD = { key: 2 }, hD = { key: 3 }, dD = { key: 4 }, pD = ["href"], mD = {
  key: 8,
  ...
  setup(t) {
    ...
    return (c, h) => {
      ...
      return s.value ? (k(), Ue(n_, {
        ...
        content: _i(() => {
          var p, m, g, y, v, b, E, O, N, M, L, I, C, R, D;
          return [
            P("div", KA, [
              ...
              s.value.description ? (k(), G("div", ZA, [
                P("span", JA, oe(x(r)("Description")), 1),
                P("span", QA, [
                  zl(P("span", null, null, 512), [
                    [d, o.value]
                  ]),
                  ...
                  a.value && (((p = o.value) == null ? void 0 : p.length) || 0) > Hc ? (k(), G("button", {
                    key: 1,
              ...
              ((m = s.value.link) == null ? void 0 : m.length) !== 0 ? (k(), G("div", nD, [
                (k(!0), G(Ge, null, kn(s.value.link, (Q) => (k(), G("div", {
                  class: "grid gap-2 grid-cols-3",
                  key: Q
                }, [
                  P("span", rD, oe(x(r)("Url vers la resource")), 1),
                  P("span", iD, [
                    P("a", {
                      class: "text-secondary hover:underline",
                      target: "_blank",
              ...
              s.value.responsibleParty ? (k(), G("div", aD, [
                ...
                P("div", lD, [
                  ...
                  (M = s.value.responsibleParty) != null && M.address ? (k(), G("p", hD, oe((L = s.value.responsibleParty) == null ? void 0 : L.address), 1)) : F("v-if", !0),
                  (I = s.value.responsibleParty) != null && I.email ? (k(), G("p", dD, [
                    P("a", {
                      class: "text-secondary hover:underline",
                      href: "mailto:" + ((C = s.value.responsibleParty) == null ? void 0 : C.email)
                    }, oe((R = s.value.responsibleParty) == null ? void 0 : R.email), 9, pD)
                  ])) : F("v-if", !0)
                ])
              ])) : F("v-if", !0),
              s.value.metadataLink ? (k(), G("div", mD, [
                P("span", gD, oe(x(r)("Link to the metadata")), 1),
                P("span", yD, [
                  P("a", {
                    class: "text-secondary hover:underline",
                    target: "_blank",
...
}), CD = /* @__PURE__ */ me(ND, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/nav-bars/language-selector.vue"]]);
class PD {
...
const LD = new PD(), kD = { class: "w-full h-14 flex bg-white shadow-header z-10 shrink-0" }, AD = /* @__PURE__ */ P("div", { class: "flex-2 p-[5px]" }, [
  /* @__PURE__ */ P("img", { src: OD })
], -1), DD = /* @__PURE__ */ P("div", { class: "grow text-center" }, "search", -1), ID = { class: "h-full flex" }, RD = { class: "hidden lg:inline-block" }, $D = { class: "border-l-[1px] border-stone-300 h-full" }, FD = /* @__PURE__ */ fe({
  __name: "header-bar",
  setup(t) {
    ...
    et(
      f,
      (h) => {
        h && LD.setCurrentThemeColors(h.name);
      },
      { immediate: !0 }
    );
    function c() {
          ...
          P("ul", ID, [
            P("li", null, [
              P("button", {
                ...
                P("span", RD, oe(x(e)(`${(m = x(f)) == null ? void 0 : m.name}`)), 1)
              ], 2)
            ]),
            P("li", $D, [
...
}), VD = /* @__PURE__ */ me(FD, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/header/header-bar.vue"]]), jD = { class: "block text-[13px] sm:text-base uppercase" }, GD = /* @__PURE__ */ fe({
  __name: "button-icon",
  props: {
    label: { type: String, required: !0 },
  ...
  setup(t) {
    ...
    return (n, r) => (k(), G("button", {
      ...
      P("span", jD, oe(e.label), 1)
    ], 2));
  }
}), kr = /* @__PURE__ */ me(GD, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/footer/button-icon.vue"]]), UD = ["href"], BD = /* @__PURE__ */ fe({
  __name: "button-link",
  props: {
    label: { type: String, required: !0 },
...
}), XD = /* @__PURE__ */ me(YD, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/footer/footer-bar.vue"]]), KD = { class: "flex flex-row flex-wrap pl-2.5" }, ZD = ["onClick"], JD = { class: "text-2xl absolute top-5" }, QD = /* @__PURE__ */ fe({
  __name: "theme-grid",
  props: {
  ...
  setup(t) {
    ...
    return (i, s) => {
      ...
      return k(), G("button", {
        ...
        P("span", nI, oe(x(e)("Theme")) + ": " + oe(x(e)(`${(a = n.currentTheme) == null ? void 0 : a.name}`)), 1),
        P("span", rI, [
          P("span", iI, oe(x(e)("Changer")), 1),
          P("span", sI, [
...
}), oI = /* @__PURE__ */ me(aI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/theme-selector/theme-selector-button.vue"]]), lI = {
  key: 0,
...
}), cI = /* @__PURE__ */ me(uI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/theme-selector/theme-selector.vue"]]);
function Jf(t, e = 0) {
...
}), dI = /* @__PURE__ */ me(hI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/catalog/catalog-tree.vue"]]), pI = /* @__PURE__ */ fe({
  __name: "catalog-tab",
  setup(t) {
...
}), mI = /* @__PURE__ */ me(pI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/catalog/catalog-tab.vue"]]);
/**!
 * Sortable 1.15.2
  ...
  return {
    ...
    animateAll: function(r) {
      ...
      t.forEach(function(o) {
        ...
        m && (c.top -= m.f, c.left -= m.e), u.toRect = c, u.thisAnimationDuration && zc(h, c) && !zc(f, c) && (p.top - c.top) / (p.left - c.left) === (f.top - c.top) / (f.left - c.left) && (l = MI(p, h, d, i.options)), zc(c, f) || (u.prevFromRect = f, u.prevToRect = c, l || (l = i.options.animation), i.animate(u, p, c, l)), l && (s = !0, a = Math.max(a, l), clearTimeout(u.animationResetTimer), u.animationResetTimer = setTimeout(function() {
...
function TI(t) {
  ...
  if (e = e || n && n[mn], !!e) {
    ...
    window.CustomEvent && !Kr && !ko ? m = new CustomEvent(r, {
      bubbles: !0,
      cancelable: !0
    ...
    var v = wr(wr({}, p), Ao.getEventProperties(r, e));
    for (var b in v)
      m[b] = v[b];
...
var J, ct, Ee, nt, Yi, $l, at, di, $s, hn, Ha, ui, cl, kt, Ps = !1, xu = !1, Ou = [], Wi, jn, Xc, Kc, og, lg, Na, Ts, za, Ya = !1, fl = !1, Fl, jt, Zc = [], Qf = !1, Mu = [], rc = typeof document < "u", hl = g_, ug = ko || Kr ? "cssFloat" : "float", CI = rc && !y_ && !g_ && "draggable" in document.createElement("div"), x_ = function() {
  if (!!rc) {
    if (Kr)
      return !1;
  ...
  _onDragOver: function(e) {
    ...
    function v(K) {
      return g("dragOverCompleted", {
        insertion: K
      }), K && (f ? u._hideClone() : u._showClone(p), p !== h && (fn(J, kt ? kt.options.ghostClass : u.options.ghostClass, !1), fn(J, o.ghostClass, !0)), kt !== p && p !== ge.active ? kt = p : p === ge.active && kt && (kt = null), h === p && (p._ignoreWhileAnimating = r), p.animateAll(function() {
    ...
    if (xu = !1, u && !o.disabled && (f ? c || (a = ct !== nt) : kt === this || (this.lastPutMode = cl.checkPull(this, u, J, e)) && l.checkPut(this, u, J, e))) {
      ...
      if (!E || RI(e, d, this) && !E.animated) {
        ...
        s = Et(r);
        var N = 0, M, L = J.parentNode !== n, I = !PI(J.animated && J.toRect || i, r.animated && r.toRect || s, d), C = d ? "top" : "left", R = sg(r, "top", "top") || sg(J, "top", "top"), D = R ? R.scrollTop : void 0;
        Ts !== r && (M = s[C], Ya = !1, fl = !I && o.invertSwap || L), N = $I(e, r, s, d, I ? 1 : o.swapThreshold, o.invertedSwapThreshold == null ? o.swapThreshold : o.invertedSwapThreshold, fl, Ts === r);
        var Q;
        if (N !== 0) {
          var ve = On(J);
          do
...
rc && je(document, "touchmove", function(t) {
  (ge.active || Ps) && t.cancelable && t.preventDefault();
});
ge.utils = {
  on: je,
  off: Ie,
...
function GI() {
  ...
  return t.prototype = {
    ...
    nulling: function() {
      Tu = th = Ca = nh = Pa = Qc = ef = null, _t.length = 0;
    },
    ...
    _handleAutoScroll: function(n, r) {
      ...
      if (Tu = n, r || this.options.forceAutoScrollFallback || ko || Kr || Wa) {
        ...
        var l = gi(o, !0);
        nh && (!Pa || s !== Qc || a !== ef) && (Pa && cg(), Pa = setInterval(function() {
...
var tf = b_(function(t, e, n, r) {
  if (!!e.scroll) {
    ...
    var c = 0, h = Ca;
    do {
      var d = h, p = Et(d), m = p.top, g = p.bottom, y = p.left, v = p.right, b = p.width, E = p.height, O = void 0, N = void 0, M = d.scrollWidth, L = d.scrollHeight, I = ye(d), C = d.scrollLeft, R = d.scrollTop;
      d === l ? (O = b < M && (I.overflowX === "auto" || I.overflowX === "scroll" || I.overflowX === "visible"), N = E < L && (I.overflowY === "auto" || I.overflowY === "scroll" || I.overflowY === "visible")) : (O = b < M && (I.overflowX === "auto" || I.overflowX === "scroll"), N = E < L && (I.overflowY === "auto" || I.overflowY === "scroll"));
      var D = O && (Math.abs(v - i) <= a && C + b < M) - (Math.abs(y - i) <= a && !!C), Q = N && (Math.abs(g - s) <= a && R + E < L) - (Math.abs(m - s) <= a && !!R);
      if (!_t[c])
      ...
      (_t[c].vx != D || _t[c].vy != Q || _t[c].el !== d) && (_t[c].el = d, _t[c].vx = D, _t[c].vy = Q, clearInterval(_t[c].pid), (D != 0 || Q != 0) && (u = !0, _t[c].pid = setInterval(function() {
        ...
        typeof f == "function" && f.call(ge.dragged.parentNode[mn], $, T, t, Tu, _t[this.layer].el) !== "continue" || E_(_t[this.layer].el, $, T);
      }.bind({
        layer: c
      }), 24))), c++;
...
ge.mount(new GI());
ge.mount(nd, td);
const P_ = 0.5, UI = !1, Nu = ps(
  "slider",
  () => {
    const t = vt(), e = we(P_), n = we(UI), r = de(
      () => [...t.layers].reverse()[0]
    );
    function i(a) {
      let o = a;
...
const BI = { class: "lux-layer-manager-item mt-2.5" }, WI = ["title"], qI = { class: "flex-1 text-left cursor-default" }, HI = ["aria-label", "title"], zI = /* @__PURE__ */ fe({
  ...
  setup(t, { emit: e }) {
    const n = t, r = e, { t: i, onClickInfo: s } = L_(n.layer, { emit: r }), a = de(
...
}), YI = /* @__PURE__ */ me(zI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-item/layer-item-background.vue"]]), XI = ["id"], KI = ["aria-checked", "title"], ZI = ["id", "value", "aria-label"], JI = ["aria-checked", "aria-label"], QI = /* @__PURE__ */ fe({
...
}), e3 = /* @__PURE__ */ me(QI, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-item/layer-item-sub.vue"]]), t3 = ["min", "max", "value"], n3 = /* @__PURE__ */ fe({
...
}), rh = /* @__PURE__ */ me(n3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-time/layer-time-datepicker.vue"]]), r3 = { class: "lux-time-slider w-full" }, i3 = ["for"], s3 = /* @__PURE__ */ fe({
...
}), a3 = /* @__PURE__ */ me(s3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-time/layer-time-datepicker-value.vue"]]), o3 = { class: "lux-time-slider w-full" }, l3 = ["for"], u3 = ["for"], c3 = /* @__PURE__ */ fe({
...
}), f3 = /* @__PURE__ */ me(c3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-time/layer-time-datepicker-range.vue"]]), h3 = ["onKeydown", "aria-label", "title"], d3 = /* @__PURE__ */ fe({
...
}), fg = /* @__PURE__ */ me(d3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/slider-range/slider-range-thumb.vue"]]), p3 = /* @__PURE__ */ fe({
...
}), m3 = /* @__PURE__ */ me(p3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/slider-range/slider-range-active-track.vue"]]), g3 = { class: "lux-slidebar-fake" }, y3 = /* @__PURE__ */ fe({
  __name: "slider-range",
  props: {
    selectedMinValue: { type: Number, required: !0 },
    selectedMaxValue: { type: Number, required: !1 },
...
}), hg = /* @__PURE__ */ me(y3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/common/slider-range/slider-range.vue"]]), v3 = { class: "lux-time-slider w-full" }, _3 = {
  key: 0,
  ...
  setup(t, { emit: e }) {
    ...
    function g() {
      ...
      const N = new Date(E.minValue), M = new Date((R = E.maxValue) != null ? R : Date.now()), L = 1024, I = new Date(N.getTime()), C = (D = E.interval) != null ? D : U0;
      if (I.setFullYear(
        N.getFullYear() + L * C[0]
      ), I.setMonth(
        N.getMonth() + L * C[1],
        N.getDate() + L * C[2]
      ), I.setSeconds(N.getSeconds() + L * C[3]), I > M)
        for (let Q = 0; ; Q++) {
    ...
    function y(E) {
      var M;
      const O = E / 100 * (o.value - a.value) + a.value, N = OP(O, {
        minValue: a.value,
        maxValue: o.value,
    ...
    return (E, O) => {
      ...
      return k(), G("div", v3, [
        ...
        P("div", E3, [
          ...
          ((L = E.layer.time) == null ? void 0 : L.mode) === x(Rr).RANGE || ((I = E.layer.time) == null ? void 0 : I.mode) === x(Rr).VALUE ? (k(), G("div", S3, [
            P("span", null, oe(f.value ? x($m)(f.value, (C = E.layer.time) == null ? void 0 : C.resolution) : "-"), 1)
          ])) : F("v-if", !0),
          F(" Display localized time values Max value "),
          ((R = E.layer.time) == null ? void 0 : R.mode) === x(Rr).RANGE ? (k(), G("div", w3, [
            P("span", null, oe(u.value ? x($m)(u.value, (D = E.layer.time) == null ? void 0 : D.resolution) : "-"), 1)
          ])) : F("v-if", !0)
        ])
      ]);
    };
  }
}), O3 = /* @__PURE__ */ me(x3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-time/layer-time-slider.vue"]]), M3 = /* @__PURE__ */ fe({
  __name: "layer-time",
  props: {
    layer: { type: Object, required: !0 }
  },
...
}), T3 = /* @__PURE__ */ me(M3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-time/layer-time.vue"]]), N3 = { class: "lux-layer-manager-item relative" }, C3 = { class: "w-full flex flex-nowrap items-start gap-x-2" }, P3 = ["title"], L3 = ["aria-label", "title"], k3 = ["aria-expanded", "aria-controls", "data-cy"], A3 = { class: "grow" }, D3 = ["title", "aria-label"], I3 = /* @__PURE__ */ fe({
  __name: "layer-item",
  props: {
  ...
  setup(t, { emit: e }) {
    const n = t, r = e, { t: i, onClickInfo: s } = L_(n.layer, { emit: r }), a = Kn(), o = de(
...
}), dg = /* @__PURE__ */ me(I3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-item/layer-item.vue"]]), R3 = {
  key: 0,
  ...
  setup(t, { emit: e }) {
    ...
    function v(L, I) {
      i.setLayerOpacity(L.id, I / 100);
    }
    function b(L, I, C) {
      i.setLayerTime(L.id, I, C);
    }
    function E(L) {
      i.removeLayers(L.id);
    }
...
}), U3 = /* @__PURE__ */ me(G3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-manager/layer-manager.vue"]]), B3 = { class: "flex flex-col h-full pt-1.5" }, W3 = { class: "h-16 shrink-0 flex justify-between lux-panel-title" }, q3 = ["aria-label"], H3 = { class: "flex flex-row gap-2 h-10 text-2xl" }, z3 = ["aria-expanded"], Y3 = { key: 0 }, X3 = ["aria-expanded"], K3 = { class: "relative grow p-2.5 bg-primary overflow-auto" }, Z3 = /* @__PURE__ */ fe({
  __name: "layer-panel",
  setup(t) {
    ...
    return (l, u) => (k(), G("div", B3, [
      ...
      P("div", W3, [
        P("h1", null, oe(x(e)("layers", { ns: "client" })), 1),
        P("span", null, [
          P("button", {
      ...
      P("div", K3, [
        ...
        x(i) ? F("v-if", !0) : (k(), Ue(mI, { key: 1 }))
      ])
    ]));
  }
}), J3 = /* @__PURE__ */ me(Z3, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/layer-panel/layer-panel.vue"]]);
class Q3 {
  bootstrap() {
    let e;
    e = vn(() => {
...
const eR = new Q3(), tR = ["onKeydown"], nR = /* @__PURE__ */ P("span", { class: "lux-slider-line" }, null, -1), rR = /* @__PURE__ */ P("span", { class: "lux-slider-arrows" }, [
  /* @__PURE__ */ P("span"),
  /* @__PURE__ */ P("span")
], -1), iR = {
  key: 0,
  class: "lux-slider-layer-label"
}, sR = /* @__PURE__ */ P("i", { class: "fa fa-arrow-left mr-2" }, null, -1), pg = 30, aR = /* @__PURE__ */ fe({
  ...
  setup(t, { expose: e, emit: n }) {
    ...
    return _n(() => {
      ...
      g.sliderTopLayer ? (k(), G("span", iR, [
        sR,
        P("span", null, oe(x(s)(g.sliderTopLayer.name)), 1)
      ])) : F("v-if", !0)
    ], 44, tR));
  }
}), oR = /* @__PURE__ */ me(aR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/slider/splitter-element.vue"]]), lR = /* @__PURE__ */ fe({
  ...
  setup(t) {
    ...
    function p() {
      ...
      !v || (c = v.on(
        ...
        function(b) {
          var R;
          const E = b.context, O = (R = r.value) == null ? void 0 : R.getSize(), N = f.value + l.value / 2, M = Ro(b, [0, 0]), L = Ro(b, [N, 0]), I = Ro(b, [0, O[1]]), C = Ro(b, [N, O[0]]);
          E.save(), E.beginPath(), E.moveTo(M[0], M[1]), E.lineTo(I[0], I[1]), E.lineTo(C[0], C[1]), E.lineTo(L[0], L[1]), E.closePath(), E.clip();
        }
      ), h = v.on(
        yd.POSTRENDER,
        function(b) {
...
}), uR = /* @__PURE__ */ me(lR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/slider/slider-comparator.vue"]]), pl = "-", rf = ",", mg = "--";
class cR {
  constructor() {
...
const pn = new cR(), fR = "basemap_2015_global", hR = "orthogr_2013_global", dR = {
...
class pR {
  ...
  getBgLayerFromStorage() {
    const e = Ne.getInitialVersion(), n = Ne.getValue(Gm);
    return n ? e === 2 ? this.getBgLayerFromStorageV2(n) : pn.bgLayerNameToBgLayer(n) : pn.bgLayerNameToBgLayer(fR);
  }
  getBgLayerFromStorageV2(e) {
    ...
    let r = "";
    return e ? r = dR[e] : n === 0 && (r = hR), pn.bgLayerNameToBgLayer(r);
  }
}
const mR = new pR();
class gR {
  ...
  restore() {
    ...
    this.restoreLayersOpacities(r, e), this.restoreLayersTimes(r), e === 2 && (Ne.removeItem(q0), Ne.removeItem(RP), Ne.removeItem(zm), Ne.removeItem(Ym)), n.addLayers(...(r == null ? void 0 : r.filter((i) => i)) || []);
  }
...
const OR = new xR(), MR = /* @__PURE__ */ fe({
...
}), TR = /* @__PURE__ */ me(MR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/simple-style-item.vue"]]), NR = { class: "text-white border-2 p-[10px] m-[10px]" }, CR = { class: "text-center mb-3" }, PR = ["title"], LR = { class: "text-white" }, kR = ["title", "onClick"], AR = { class: "flex" }, DR = /* @__PURE__ */ fe({
  ...
  setup(t) {
    ...
    return (l, u) => (k(), G("div", NR, [
      ...
      P("h5", CR, oe(x(e)("Select a style", { ns: "client" })), 1),
      (k(!0), G(Ge, null, kn(a.value, (f) => (k(), G("div", {
        ...
        P("span", LR, oe(x(e)(f.unlocalized_label, { ns: "client" })) + " : ", 1),
        P("button", {
...
}), IR = /* @__PURE__ */ me(DR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/simple-style-selector.vue"]]);
function RR(t) {
  const e = $R(t);
...
const FR = { class: "flex w-full items-center" }, VR = {
  ...
  setup(t, { emit: e }) {
    ...
    return (o, l) => (k(), G("div", FR, [
      P("label", VR, oe(x(n)(o.style.label)), 1),
      P("div", jR, [
...
}), WR = /* @__PURE__ */ me(BR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/medium-style-item.vue"]]), qR = { class: "text-white border-2 p-[10px] m-[10px]" }, HR = { class: "text-center mb-3" }, zR = /* @__PURE__ */ fe({
  ...
  setup(t) {
    ...
    return (u, f) => (k(), G("div", qR, [
      P("h5", HR, oe(a.value ? x(i)("Select a colour for every theme") : x(i)("Activate categories")), 1),
...
}), YR = /* @__PURE__ */ me(zR, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/medium-style-selector.vue"]]);
var k_ = { exports: {} };
(function(t, e) {
  (function(n, r) {
    r();
...
const XR = { class: "text-white border-2 p-[10px] m-[10px] flex flex-col" }, KR = { class: "text-center mb-3" }, ZR = { class: "flex flex-row justify-center" }, JR = { class: "absolute top-[70px] w-full text-center text-base leading-3 font-medium text-white" }, QR = { class: "text-white border-2 relative h-[100px] w-[85px] mx-[10px] my-0 mb-[15px] text-sm" }, e4 = {
  ...
  setup(t) {
    ...
    return (u, f) => (k(), G("div", XR, [
      P("h5", KR, oe(x(s)("Lancer \xE9diteur externe ou importer json")), 1),
      P("div", ZR, [
        P("a", {
          href: "#",
          ...
          P("span", JR, oe(x(s)("Download style")), 1)
        ]),
        P("div", QR, [
          P("label", e4, [
            P("span", t4, oe(x(s)("Upload style")), 1)
          ]),
          P("input", {
            class: "invisible",
            type: "file",
...
}), i4 = /* @__PURE__ */ me(r4, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/expert-style-selector.vue"]]), s4 = { key: 0 }, a4 = {
  key: 0,
  class: "mb-px"
}, o4 = {
  key: 1,
...
}), c4 = /* @__PURE__ */ me(u4, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/components/style-selector/style-selector.vue"]]);
function ih(t) {
      ...
      (function(a) {
        ...
        function C(T) {
          ...
          return T.trim().split("&").forEach(function(z) {
            if (z) {
              var K = z.split("="), Ce = K.shift().replace(/\+/g, " "), Le = K.join("=").replace(/\+/g, " ");
...
`) === 0 ? K.substr(1, K.length) : K;
            ...
            var Ce = K.split(":"), Le = Ce.shift().trim();
            if (Le) {
              var dt = Ce.join(":").trim();
              $.append(Le, dt);
            }
        ...
        return ve.polyfill = !0, o.fetch || (o.fetch = ve, o.Headers = m, o.Request = I, o.Response = D), a.Headers = m, a.Request = I, a.Response = D, a.fetch = ve, a;
      })({});
...
const D_ = Cu.exports, yg = /* @__PURE__ */ pb({
  __proto__: null,
  default: D_
}, [Cu.exports]);
function vg(t, e) {
...
var Pu;
typeof ActiveXObject == "function" && (typeof global < "u" && global.ActiveXObject ? Pu = global.ActiveXObject : typeof window < "u" && window.ActiveXObject && (Pu = window.ActiveXObject));
!Gr && yg && !lo && !Pu && (Gr = D_ || yg);
...
var sh = function(e, n) {
  ...
  try {
    var s;
    lo ? s = new lo() : s = new Pu("MSXML2.XMLHTTP.3.0"), s.open(r ? "POST" : "GET", n, 1), e.crossDomain || s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), s.withCredentials = !!e.withCredentials, r && s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), s.overrideMimeType && s.overrideMimeType("application/json");
...
}, C4 = { class: "map-wrapper grow bg-blue-100 relative" }, P4 = { class: "absolute right-1 top-16" }, L4 = /* @__PURE__ */ fe({
  __name: "App",
  setup(t) {
    const e = wt();
    OR.bootstrap(), yR.bootstrap(), ER.bootstrap(), wR.bootstrapLayersOpen(), Y0.bootstrapStyle(), mR.bootstrap();
    ...
    ), _n(() => window.addEventListener("resize", i)), Pi(() => window.removeEventListener("resize", i));
    function i() {
      const s = Vr().getOlMap();
...
}), k4 = /* @__PURE__ */ me(L4, [["__file", "/home/tkohr/Projets/luxembourg/git/luxembourg-geoportail/src/App.vue"]]);
EN();
lt.use($_);
lt.init({
  lng: "fr",
...
export {
  ...
  mR as statePersistorBgLayerService,

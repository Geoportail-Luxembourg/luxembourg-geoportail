 ...
 */
export const LUX_TPL_ICON_PATHS = {
  'caret-down': 'M3.5 6h9L8 11.5 3.5 6Z',
  'caret-up': 'M3.5 10h9L8 4.5 3.5 10Z',
  download:
    'M7.25 1.75h1.5v5.19l1.72-1.72 1.06 1.06L8 9.81 4.47 6.28l1.06-1.06 1.72 1.72V1.75ZM2.5 11.5H4v1.75h8V11.5h1.5v3.25h-11V11.5Z',
  ...
  phone:
    'M4.6 1.9a1 1 0 0 0-1.35.06L2.1 3.1a2 2 0 0 0-.35 2.35 15.5 15.5 0 0 0 6.8 6.8 2 2 0 0 0 2.35-.35l1.14-1.15a1 1 0 0 0 .06-1.35l-1.9-2.2a1 1 0 0 0-1.46-.05l-.9.9a12.2 12.2 0 0 1-3.14-3.14l.9-.9a1 1 0 0 0-.05-1.46L4.6 1.9Z',

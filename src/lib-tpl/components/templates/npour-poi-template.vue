...
<template>
  <InfoFeatureLayout :layers="layers" :currentUrl="currentUrl">
    <template #feature-content="{ feature }">
      ...
      <h3
        class="lux-tpl-npour-poi-h3"
        v-if="i18next.language == 'de' && hasProperty('nom_de', feature, 0)"
      >
        {{ feature.attributes.nom_de }}
      </h3>
      <h3
        class="npour-poi-h3"
        v-if="i18next.language == 'fr' && hasProperty('nom_fr', feature, 0)"
      >
        {{ feature.attributes.nom_fr }}
      </h3>
      <h3
        class="npour-poi-h3"
        v-if="i18next.language == 'en' && hasProperty('nom_en', feature, 0)"
      >
        {{ feature.attributes.nom_en }}
      </h3>
      <h3
        class="npour-poi-h3"
        v-if="i18next.language == 'lb' && hasProperty('nom_lu', feature, 0)"
      >

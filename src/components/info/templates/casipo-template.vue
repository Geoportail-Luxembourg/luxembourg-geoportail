...
const URL_CASIPO_PROD = import.meta.env.VITE_CASIPO_PROD_URL
...
.casipo-checkbox input[type='checkbox'] {
  vertical-align: middle;
  margin-right: 5px;
}
.casipo-form-container {
  margin-left: 20px;
}
.casipo-form-container label {
  display: inline;
}
.casipo-mail {
  margin-bottom: 10px;
...
<template>
  ...
  <div class="lux-feature-info">
    <div class="poi-feature">
      ...
      <br />
      <br />
      <div class="casipo-form-container">
        <div class="casipo-mail">
          <label>{{ t('Adresse Email') }}</label>
          <input type="text" v-model="mail" style="width: 165px" />
        </div>
        <div class="casipo-checkbox">

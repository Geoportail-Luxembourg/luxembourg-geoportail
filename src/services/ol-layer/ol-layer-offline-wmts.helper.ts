...
class OlLayerWmtsOfflineHelper {
  ...
  // TODO: GSLUX-667-offline-mode à faire deserializeTileLayer commen dans v3 (en améliorant le code)
  ...
  createOlLayer(layer: Layer): OlLayer /* Returns: ImageLayer<ImageWMS> */ {
    ...
    // ce code est un exemple copié/collé d'une autre facotry, il faut le modifier pour gérer les sources WMTS offline

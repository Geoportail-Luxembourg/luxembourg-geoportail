 ...
 */
export default function rulesReadHelper() {
  function processRules(paramKeys: ParamKeys) {
    if (ruleUseLocalStorage(paramKeys)) {
  ...
  function processRulesForKey(key: string, paramKeys: ParamKeys) {

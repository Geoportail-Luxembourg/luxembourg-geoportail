describe('Feature Info', () => {
  ...
  describe.skip('Default template', () => {
     ...
     * /theme/main?version=3&lang=fr&X=702429&Y=6396653&zoom=16&rotation=0&features=&layers=655-2842-808-1713-1714-152-302-1813&opacities=1-0-1-1-1-1-1-1&time=--------------&bgLayer=roadmap
     */

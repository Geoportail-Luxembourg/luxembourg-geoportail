  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        route_sm:
          "url('/assets/images/backgroundselector/routiere_sm.png')",
        topo_bw_sm:
          "url('/assets/images/backgroundselector/topo_nb_sm.png')",
        topo_sm: "url('/assets/images/backgroundselector/topo_sm.png')",
        ortho_sm:
          "url('/assets/images/backgroundselector/orthophoto_sm.png')",
        hybrid_sm: "url('/assets/images/backgroundselector/hybrid_sm.png')",
        route_hi:
          "url('/assets/images/backgroundselector/routiere_retina.png')",
        topo_bw_hi:
          "url('/assets/images/backgroundselector/topo_nb_retina.png')",
        topo_hi: "url('/assets/images/backgroundselector/topo_retina.png')",
        ortho_hi:
          "url('/assets/images/backgroundselector/orthophoto_retina.png')",
        hybrid_hi:
          "url('/assets/images/backgroundselector/hybrid_retina.png')",
        route_sm_hi:
          "url('/assets/images/backgroundselector/routiere_sm_retina.png')",
        topo_bw_sm_hi:
          "url('/assets/images/backgroundselector/topo_nb_sm_retina.png')",
        topo_sm_hi:
          "url('/assets/images/backgroundselector/topo_sm_retina.png')",
        ortho_sm_hi:
